pipeline {
    ...
    parameters {
        ...
        choice(name: 'GITHUB_REPO', choices: ['magestore-shark/pos-standard', 'magestore-shark/pos-pro', 'magestore-shark/pos-enterprise', 'abel274/pos-pro-commerce', 'abel274/pos-enterprise-commerce', 'Magestore/pos-standard', 'Magestore/pos-pro', 'Magestore/pos-enterprise', 'Magestore/pos-pro-commerce', 'Magestore/pos-enterprise-commerce'], description: 'Github repository')
