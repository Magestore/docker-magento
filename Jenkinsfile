pipeline {
    ...
    parameters {
        ...
        choice(name: 'MAGENTO_VERSION', choices: ['2.3.4', '2.3.3', '2.3.2', '2.3.1', '2.3.0', '2.2.10', '2.2.9', '2.2.8', '2.2.7', '2.2.6', '2.1.17', '2.1.16', 'ee-2.3.4', 'ee-2.3.3'], description: 'Magento Version')
